const Projects = () => {
    return (
        <section id="projects" className="bg-white py-12 px-4 md:px-20 border border-gray-300 max-w-screen-lg mx-auto rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg shadow-md border border-gray-200">
                        ...
                        <div className="mt-2 flex justify-between">
                            ...
                            <a href="https://github.com/OumaBon/shop "target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline font-didact">Source Code</a>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg shadow-md border border-gray-200">
                        ...
                        <div className="mt-2 flex justify-between">
                            <a href="#" className="text-orange-500 hover:underline font-didact">Live Demo</a>
                            <a href="https://github.com/OumaBon/portfolio-" target="_blank" rel="noopener noreferrer"  className="text-orange-500 hover:underline font-didact">Source Code</a>
                        </div>
                    </div>
